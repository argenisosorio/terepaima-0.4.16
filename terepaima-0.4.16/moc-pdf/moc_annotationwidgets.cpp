...
struct qt_meta_stringdata_qpdfview__AnnotationWidget_t {
    QByteArrayData data[4];
    char stringdata[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__AnnotationWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__AnnotationWidget_t qt_meta_stringdata_qpdfview__AnnotationWidget = {
    {
...
QT_MOC_LITERAL(3, 40, 14)
    ...
    "qpdfview::AnnotationWidget\0wasModified\0"
    "\0on_textChanged"
};
...
void qpdfview::AnnotationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AnnotationWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AnnotationWidget::wasModified)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject qpdfview::AnnotationWidget::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_qpdfview__AnnotationWidget.data,
      qt_meta_data_qpdfview__AnnotationWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__AnnotationWidget.stringdata))
...
struct qt_meta_stringdata_qpdfview__FileAttachmentAnnotationWidget_t {
    QByteArrayData data[6];
    char stringdata[115];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__FileAttachmentAnnotationWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__FileAttachmentAnnotationWidget_t qt_meta_stringdata_qpdfview__FileAttachmentAnnotationWidget = {
    {
QT_MOC_LITERAL(0, 0, 40),
QT_MOC_LITERAL(1, 41, 14),
QT_MOC_LITERAL(2, 56, 0),
QT_MOC_LITERAL(3, 57, 14),
QT_MOC_LITERAL(4, 72, 17),
QT_MOC_LITERAL(5, 90, 24)
    },
    "qpdfview::FileAttachmentAnnotationWidget\0"
    "on_aboutToShow\0\0on_aboutToHide\0"
    "on_save_triggered\0on_saveAndOpen_triggered"
};
#undef QT_MOC_LITERAL
...
const QMetaObject qpdfview::FileAttachmentAnnotationWidget::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_qpdfview__FileAttachmentAnnotationWidget.data,
      qt_meta_data_qpdfview__FileAttachmentAnnotationWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__FileAttachmentAnnotationWidget.stringdata))
