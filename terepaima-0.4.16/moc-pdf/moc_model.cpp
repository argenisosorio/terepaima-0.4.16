...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__Model__Annotation_t, stringdata) + ofs \
...
void qpdfview::Model::Annotation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Annotation *_t = static_cast<Annotation *>(_o);
        switch (_id) {
        ...
        {
            typedef void (Annotation::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Annotation::wasModified)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject qpdfview::Model::Annotation::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qpdfview__Model__Annotation.data,
      qt_meta_data_qpdfview__Model__Annotation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__Model__Annotation.stringdata))
        return static_cast<void*>(const_cast< Annotation*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__Model__FormField_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FormField *_t = static_cast<FormField *>(_o);
        switch (_id) {
        case 0: _t->wasModified(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (FormField::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FormField::wasModified)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject qpdfview::Model::FormField::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qpdfview__Model__FormField.data,
      qt_meta_data_qpdfview__Model__FormField,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__Model__FormField.stringdata))
        return static_cast<void*>(const_cast< FormField*>(this));
    return QObject::qt_metacast(_clname);
}
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__SettingsWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject qpdfview::SettingsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_qpdfview__SettingsWidget.data,
      qt_meta_data_qpdfview__SettingsWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__SettingsWidget.stringdata))
