...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__Database_t, stringdata) + ofs \
...
const QMetaObject qpdfview::Database::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qpdfview__Database.data,
      qt_meta_data_qpdfview__Database,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__Database.stringdata))
