...
struct qt_meta_stringdata_qpdfview__HelpDialog_t {
    QByteArrayData data[5];
    char stringdata[91];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__HelpDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__HelpDialog_t qt_meta_stringdata_qpdfview__HelpDialog = {
    {
...
QT_MOC_LITERAL(4, 70, 20)
    ...
    "qpdfview::HelpDialog\0on_findPrevious_triggered\0"
    "\0on_findNext_triggered\0on_search_textEdited"
};
...
const QMetaObject qpdfview::HelpDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_qpdfview__HelpDialog.data,
      qt_meta_data_qpdfview__HelpDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__HelpDialog.stringdata))
