...
static const char qt_meta_stringdata_qpdfview__RecentlyUsedMenu[] = {
    "qpdfview::RecentlyUsedMenu\0\0filePath\0"
    "openTriggered(QString)\0action\0"
    "on_open_triggered(QAction*)\0"
...
const QMetaObjectExtraData qpdfview::RecentlyUsedMenu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject qpdfview::RecentlyUsedMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_qpdfview__RecentlyUsedMenu,
      qt_meta_data_qpdfview__RecentlyUsedMenu, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qpdfview::RecentlyUsedMenu::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__RecentlyUsedMenu))
