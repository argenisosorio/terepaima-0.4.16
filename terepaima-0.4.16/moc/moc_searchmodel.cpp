...
struct qt_meta_stringdata_qpdfview__SearchModel_t {
    QByteArrayData data[3];
    char stringdata[56];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qpdfview__SearchModel_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qpdfview__SearchModel_t qt_meta_stringdata_qpdfview__SearchModel = {
    {
QT_MOC_LITERAL(0, 0, 21),
QT_MOC_LITERAL(1, 22, 32),
QT_MOC_LITERAL(2, 55, 0)
    },
    "qpdfview::SearchModel\0"
...
const QMetaObject qpdfview::SearchModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_qpdfview__SearchModel.data,
      qt_meta_data_qpdfview__SearchModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qpdfview__SearchModel.stringdata))
